      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <div className="about__buttons" ref={dropdownRef}>
            ...
            <div className={`cv__dropdown ${showOptions ? 'active' : ''}`}>
              <a href="/pdf/CV_Narongsak_TH.pdf" target="_blank" rel="noopener noreferrer" className="cv__item">
                <i className="uil uil-file-alt"></i> Thai Version
              </a>
              <a href="/pdf/CV_Narongsak_ENG.pdf" target="_blank" rel="noopener noreferrer" className="cv__item">
                <i className="uil uil-file-alt"></i> English Version
              </a>
            </div>
          </div>
        </div>
