...
const Contact = () => {
    ...
    return (
        <section className="contact section" id="contact">
            <h2 className="section__title" style={{ textAlign: "center", margin: "0 auto" }}>Get in Touch</h2>
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <h3 className="contact__card-title">Email</h3> 
                            <sapan className="contact__card-data">narongsak.kaewp@gmail.com</sapan>

                            <a href="mailto:narongsak.kaewp@gmail.com"
                                className="contact__button">Write an email to me {""}
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail}
                        ...
                        <button className="button button--flex" style={{ fontFamily: 'poppins, "Noto Sans Thai", sans-serif' }}>
                            Send Message
                            <svg
                                class="button__icon"
                                xmlns="http://www.w3.org/2000/svg"
